...
support = extrusion(pos=vector(7, gh / 2, 10),
                    path=[vector(0, 0, 0), vector(0, gh, 0), vector(0, gh, ga), vector(0, 0, ga)],
...
# Display a pyramid
pyramid(pos=vector(-4, 0, -5), size=vector(2, 2, 2), axis=vector(0, 3, 0), color=vector(0, .5, 0),
